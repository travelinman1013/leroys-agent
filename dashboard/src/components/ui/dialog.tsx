/**
 * Operator's Desk Dialog primitive — modal centered overlay.
 *
 * Used for short confirmations and small forms (CreateJobDialog,
 * ForkDialog, InstallSkillDialog). For full editors use Sheet.
 */
...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        "fixed left-1/2 top-1/2 z-50 w-full max-w-lg -translate-x-1/2 -translate-y-1/2 border border-rule bg-card p-6",
