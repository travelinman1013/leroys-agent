...
MEMORY_SCHEMA = {
    ...
    "description": (
        ...
        "Two targets: 'user' (name, role, preferences, style) and 'memory' (environment, "
        "conventions, quirks, lessons). Act proactively on corrections and preferences.\n"
        "Actions: add, replace (old_text identifies entry), remove (old_text identifies entry).\n"
        "Skip task progress and re-discoverable info — use session_search for those."
    ),
    "parameters": {
        "type": "object",
        "properties": {
